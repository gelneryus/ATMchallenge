package com.atm.account.client;
...
@Component
public class TransactionRestClientAccount {

    private static final Logger log = LoggerFactory.getLogger(TransactionRestClientAccount.class);
    ...
    public TransactionRestClientAccount(RestTemplate restTemplate) {
